...
window.LUCIDE_PATHS = {
  ...
  "rocket": `<path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"></path>
  ...
  "server": `<rect width="20" height="8" x="2" y="2" rx="2" ry="2"></rect>
  ...
  "globe-2": `<path d="M21.54 15H17a2 2 0 0 0-2 2v4.54"></path>
  ...
  "flask-conical": `<path d="M14 2v6a2 2 0 0 0 .245.96l5.51 10.08A2 2 0 0 1 18 22H6a2 2 0 0 1-1.755-2.96l5.51-10.08A2 2 0 0 0 10 8V2"></path>
  <path d="M6.453 15h11.094"></path>
  <path d="M8.5 2h7"></path>`,
  "code-2": `<path d="m18 16 4-4-4-4"></path>
  <path d="m6 8-4 4 4 4"></path>
  <path d="m14.5 4-5 16"></path>`,
  "bar-chart-3": `<path d="M3 3v16a2 2 0 0 0 2 2h16"></path>
  <path d="M18 17V9"></path>
  <path d="M13 17V5"></path>
  <path d="M8 17v-3"></path>`,
  "receipt": `<path d="M12 17V7"></path>
  ...
  "sliders-horizontal": `<path d="M10 5H3"></path>
  ...
  <path d="M8 10v4"></path>
  <path d="M8 12H3"></path>`,
  "landmark": `<path d="M10 18v-7"></path>
  ...
  "heart-pulse": `<path d="M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5"></path>
  <path d="M3.22 13H9.5l.5-1 2 4.5 2-7 1.5 3.5h5.27"></path>`,
  "factory": `<path d="M12 16h.01"></path>
